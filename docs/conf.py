...
html_theme_options = {
    ...
    'github_repo': 'flask-iiif',
    'github_button': False,
    'github_banner': True,
    'show_powered_by': False,
    'extra_nav_links': {
        'flask-iiif@GitHub': 'https://github.com/inveniosoftware/flask-iiif',
        'flask-iiif@PyPI': 'https://pypi.python.org/pypi/flask-iiif/',
    }
}
...
htmlhelp_basename = 'flask-iiif_namedoc'
...
latex_documents = [
    (master_doc, 'Flask-IIIF.tex', u'Flask-IIIF Documentation',
     u'CERN', 'manual'),
]
...
man_pages = [
    (master_doc, 'flask-iiif', u'Flask-IIIF Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Flask-IIIF', u'Flask-IIIF Documentation',
     author, 'flask-iiif', 'Flask-IIIF extension provides easy IIIF API standard integration.',
     'Miscellaneous'),
]
